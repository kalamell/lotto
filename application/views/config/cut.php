    ...
    <div class='col-md-6'>
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">เรทราคาคัด</h3>
        </div>
        <?php echo form_open('config/update_cut');?>
        <div class="box-body">
          ...
          <table class='table table-bordered table-striped'>
            ...
            <tbody>
              ...
              if (count($r)>0) {
                ...
                $run_top = $r->run_top;
                $run_down = $r->run_down;
                $total = $two_top+ $two_down+$three_tod+$three_down+$three_top+$run_down+$run_top;
              }
              ?>
              <tr>
                <td>2 ตัวบน</td>
