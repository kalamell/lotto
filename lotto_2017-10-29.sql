...
# Database: lotto
# Generation Time: 2017-10-29 14:20:22 +0000
# ************************************************************
...
# Dump of table config_cut
# ------------------------------------------------------------

DROP TABLE IF EXISTS `config_cut`;

CREATE TABLE `config_cut` (
  `idconfig` int(11) NOT NULL AUTO_INCREMENT,
  `two_top` double DEFAULT NULL,
  `two_down` double DEFAULT NULL,
  `three_top` double DEFAULT NULL,
  ...
  `run_down` double DEFAULT NULL,
  PRIMARY KEY (`idconfig`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตั้งค่าเรตการคัด';

LOCK TABLES `config_cut` WRITE;
/*!40000 ALTER TABLE `config_cut` DISABLE KEYS */;

INSERT INTO `config_cut` (`idconfig`, `two_top`, `two_down`, `three_top`, `three_down`, `three_tod`, `run_top`, `run_down`)
VALUES
	(1,50,50,50,50,50,50,50);

/*!40000 ALTER TABLE `config_cut` ENABLE KEYS */;
UNLOCK TABLES;
...
# Dump of table sale_cut
# ------------------------------------------------------------

DROP TABLE IF EXISTS `sale_cut`;

CREATE TABLE `sale_cut` (
...
LOCK TABLES `sale_cut` WRITE;
/*!40000 ALTER TABLE `sale_cut` DISABLE KEYS */;

INSERT INTO `sale_cut` (`idsalecut_detail`, `idsale_detail`, `idsale`, `no`, `two_top`, `two_down`, `three_top`, `three_down`, `three_tod`, `top_run`, `down_run`, `lot_id`)
VALUES
	(1,68,2,'00',50,0,0,0,0,0,0,1),
	(2,67,2,'492',0,0,0,0,0,0,0,1);

/*!40000 ALTER TABLE `sale_cut` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(67,2,'492',0,0,100,0,100,0,0,1),
	(68,2,'00',100,0,0,0,0,0,0,1);
...
# Dump of table sale_send
# ------------------------------------------------------------

DROP TABLE IF EXISTS `sale_send`;

CREATE TABLE `sale_send` (
...
LOCK TABLES `sale_send` WRITE;
/*!40000 ALTER TABLE `sale_send` DISABLE KEYS */;

INSERT INTO `sale_send` (`idsalesend_detail`, `idsale_detail`, `idsale`, `no`, `two_top`, `two_down`, `three_top`, `three_down`, `three_tod`, `top_run`, `down_run`, `lot_id`)
VALUES
	(1,68,2,'00',50,0,0,0,0,0,0,1);

/*!40000 ALTER TABLE `sale_send` ENABLE KEYS */;
UNLOCK TABLES;
